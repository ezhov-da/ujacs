...
public class LoadZipFromServer {
    ...
    public String load() throws Exception {
        ...
        String pathToSave =
                AbsolutePath.getAbsolutePath(LoadZipFromServer.class) +
                        File.separator +
                        propertyHttpHolder.getProperty(PropertiesConst.NAME_FOLDER_APP_SERVICE_REAL) +
                        File.separator +
                        propertyHttpHolder.getProperty(PropertiesConst.NAME_OUTPUT_ARCHIVE_APP_SERVICE_INSTALL);
        ...
        String fullURLToArchive =
                propertyHttpHolder.getProperty(PropertiesConst.HTTP_INSTALL_APP_SERVICE_LOADER_REAL) +
                        "_" +
                        versionAppService +
                        ".zip";
