 ...
 * таим образом когда нужно обновить сервис приложений, dsrk.xftv cthdbc, сервис приложений читает это
...
//            {
//                Logger.getLogger(ServerSocketUpdateApp.class.getName()).log(Level.SEVERE, null, ex);
//            }
//        }
    }
}
