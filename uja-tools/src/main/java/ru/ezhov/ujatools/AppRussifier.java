...
public class AppRussifier {
    ...
    public static final void runRussifier() {
        ...
        UIManager.put("FileChooser.goUp", "Вверх");
        UIManager.put("JXErrorPane.ok_button_text", "OK");
        UIManager.put("JXErrorPane.details_expand_text", "Подробно>>");
        UIManager.put("JXErrorPane.details_contract_text", "Подробно<<");
        UIManager.put("JXErrorPane.copy_to_clipboard_button_text", "Копировать в буфер обмена");
        UIManager.put("JXErrorPane.fatal_button_text", "Закрыть");
        UIManager.put("OptionPane.cancelButtonText", "Отмена");
        UIManager.put("OptionPane.noButtonText", "Нет");
        UIManager.put("OptionPane.okButtonText", "OK");
        UIManager.put("OptionPane.yesButtonText", "Да");
